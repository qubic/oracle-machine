...
/**
 * MEXC exchange price provider.
 * API: https://api.mexc.com/api/v3/klines
 * Symbol format: BTCUSDT (uppercase, no separator)
 */
class MexcPriceProvider : public ExchangePriceProvider
{
public:
    explicit MexcPriceProvider(const std::string& apiKey = "");
...
private:
    static constexpr const char* BASE_URL = "https://api.mexc.com";
